...
module bar@1.0 {
    requires foo;
    view bar.provider1 {
        provides service com.foo.Provider with com.bar.MyProvider1;
    }
    view bar.provider2 {
        provides service com.foo.Provider with com.bar.MyProvider2;
    }
}
EOF

mk z.src/bar/com/bar/MyProvider1.java <<EOF
package com.bar;
import com.foo.Provider;
public class MyProvider1 extends Provider {
    public MyProvider1() { }
}
EOF

mk z.src/bar/com/bar/MyProvider2.java <<EOF
package com.bar;
import com.foo.Provider;
public class MyProvider2 extends Provider {
    public MyProvider2() { }
}
EOF
...
$BIN/jmod -J-esa -L z.lib create
$BIN/jmod -J-esa -L z.lib install z.modules `ls z.src`
$BIN/jmod -J-esa -L z.lib ls -v
$BIN/java -esa -L z.lib -m gus 2
